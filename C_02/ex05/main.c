...
int main()
{
    char *Atest = "Teste com MAIÚSCULA e acento ";
	char *strtest = "VAIQUEDÁ";
    ...
    ft_loopchar(Atest);
	ft_putnbr(ft_str_is_uppercase(strtest));
    ft_putchar('\n');
	ft_loopchar(btest);
	...
	ft_putchar('\n');
	ft_loopchar(etest);
	ft_putnbr(ft_str_is_uppercase(str5));
	ft_putchar('\n');
	ft_loopchar(ftest);
	ft_putnbr(ft_str_is_uppercase(str6));
	ft_putchar('\n');
	ft_loopchar(gtest);
	ft_putnbr(ft_str_is_uppercase(str7));
