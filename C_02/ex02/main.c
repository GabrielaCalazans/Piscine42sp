...
int main()
{
	...
	char *str4 = "Gatalouca";
	char *etest = "Teste com letras e espaço ";
 	char *str5 = "Gata louca";
    ...
    ft_loopchar(Atest);
	ft_putnbr(ft_str_is_alpha(strtest));
    ft_putchar('\n');
	ft_loopchar(btest);
	...
	ft_putchar('\n');
	ft_loopchar(dtest);
	ft_putnbr(ft_str_is_alpha(str4));
	ft_putchar('\n');
	ft_loopchar(etest);
	ft_putnbr(ft_str_is_alpha(str5));
	ft_putchar('\n');
	ft_loopchar(ftest);
	ft_putnbr(ft_str_is_alpha(str6));
	ft_putchar('\n');
	ft_loopchar(gtest);
	ft_putnbr(ft_str_is_alpha(str7));
